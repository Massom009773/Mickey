...
OWNER_ID = int(getenv("OWNER_ID", "6019689682"))
MONGO_URL = getenv("MONGO_URL", None)
SUPPORT_GRP = getenv("SUPPORT_GRP", "innocentop")
UPDATE_CHNL = getenv("UPDATE_CHNL", "about_meeBacha")
OWNER_USERNAME = getenv("OWNER_USERNAME", "massomop")
